...
export const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="animate-fade-up mt-8 max-w-xl" style={{ animationDelay: '0.55s', animationFillMode: 'both' }}>
        <p className="text-slate-400 text-lg leading-relaxed">
          {personalInfo.bio}
        </p>
      </div>

      <div className="animate-fade-up mt-10 flex flex-wrap gap-4 items-center" style={{ animationDelay: '0.7s', animationFillMode: 'both' }}>
        <button
      ...
      {personalInfo.availableForWork && (
        <div className="animate-fade-up mt-8" style={{ animationDelay: '0.85s', animationFillMode: 'both' }}>
      ...
      <button
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 text-slate-600 hover:text-teal-400 transition-colors animate-bounce hidden md:block"
      >
        <ArrowDown size={20} />
      </button>
    </section>
